...
In this tutorial, we will observe various network traffic activity to and from Azure Virtual Machines with Wireshark as well as experiment with Network Security Groups. <br />
